...
workspace_name = "capstone" # PLACEHOLDER
subscription_id = "f08c5f25-28be-4c21-993c-ad64d5c84d3a" # PLACEHOLDER
resource_group = "ML" # PLACEHOLDER
experiment_name = "Capstone" # PLACEHOLDER
iteration = "11"  # PLACEHOLDER
run_id = "9213a29f-a51b-415d-ba54-7b54b2318e94_11"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'path':None,'name':'placeholder','subscription_id':'f08c5f25-28be-4c21-993c-ad64d5c84d3a','resource_group':'ML','workspace_name':'capstone','region':'westeurope','compute_target':'worker','spark_service':None,'azure_service':None,'many_models':False,'pipeline_fetch_max_batch_size':1,'iterations':1000,'primary_metric':'normalized_root_mean_squared_error','task_type':'regression','data_script':None,'validation_size':0.0,'n_cross_validations':30,'y_min':None,'y_max':None,'num_classes':None,'featurization':'auto','_ignore_package_version_incompatibilities':False,'is_timeseries':True,'max_cores_per_iteration':1,'max_concurrent_iterations':1,'iteration_timeout_minutes':None,'mem_in_mb':None,'enforce_time_on_windows':True,'experiment_timeout_minutes':18,'experiment_exit_score':None,'whitelist_models':None,'blacklist_algos':['ExtremeRandomTrees','AutoArima','Prophet'],'supported_models':['Naive','SGD','SeasonalNaive','RandomForest','TCNForecaster','LassoLars','DecisionTree','KNN','AutoArima','LightGBM','TensorFlowLinearRegressor','SeasonalAverage','XGBoostRegressor','Average','Prophet','ExtremeRandomTrees','ElasticNet','TensorFlowDNN','GradientBoosting'],'auto_blacklist':True,'blacklist_samples_reached':False,'exclude_nan_labels':True,'verbosity':20,'_debug_log':'automl.log','show_warnings':False,'model_explainability':True,'service_url':None,'sdk_url':None,'sdk_packages':None,'enable_onnx_compatible_models':False,'enable_split_onnx_featurizer_estimator_models':False,'vm_type':'STANDARD_D2_V2','telemetry_verbosity':20,'send_telemetry':True,'enable_dnn':False,'scenario':'SDK-1.13.0','environment_label':None,'force_text_dnn':False,'enable_feature_sweeping':False,'time_column_name':'week','grain_column_names':['country'],'drop_column_names':[],'max_horizon':10,'dropna':False,'overwrite_columns':True,'transform_dictionary':{'min':'_automl_target_col','max':'_automl_target_col','mean':'_automl_target_col'},'window_size':10,'country_or_region':None,'lags':{'_automl_target_col':['auto']},'feature_lags':None,'seasonality':'auto','use_stl':None,'short_series_handling':True,'freq':'W','short_series_handling_configuration':'auto','enable_early_stopping':False,'early_stopping_n_iters':10,'metrics':None,'enable_ensembling':True,'enable_stack_ensembling':False,'ensemble_iterations':15,'enable_tf':False,'enable_subsampling':False,'subsample_seed':None,'enable_nimbusml':False,'enable_streaming':False,'force_streaming':False,'track_child_runs':True,'allowed_private_models':[],'label_column_name':'rate_14_day','weight_column_name':None,'cv_split_column_names':None,'enable_local_managed':False,'_local_managed_run_id':None,'cost_mode':1,'lag_length':0,'metric_operation':'minimize','preprocess':True} # PLACEHOLDER
pipeline_spec = "{\"pipeline_id\":\"__AutoML_Ensemble__\",\"objects\":[{\"module\":\"azureml.train.automl.ensemble\",\"class_name\":\"Ensemble\",\"spec_class\":\"sklearn\",\"param_args\":[],\"param_kwargs\":{\"automl_settings\":\"{'task_type':'regression','primary_metric':'normalized_root_mean_squared_error','verbosity':20,'ensemble_iterations':15,'is_timeseries':True,'name':'placeholder','compute_target':'worker','subscription_id':'f08c5f25-28be-4c21-993c-ad64d5c84d3a','region':'westeurope','time_column_name':'week','grain_column_names':['country'],'max_horizon':10,'drop_column_names':[],'spark_service':None}\",\"ensemble_run_id\":\"9213a29f-a51b-415d-ba54-7b54b2318e94_11\",\"experiment_name\":\"Capstone\",\"workspace_name\":\"capstone\",\"subscription_id\":\"f08c5f25-28be-4c21-993c-ad64d5c84d3a\",\"resource_group_name\":\"ML\"}}]}" # PLACEHOLDER
pipeline_id = "__AutoML_Ensemble__" # PLACEHOLDER
dataprep_json = "{\"training_data\": {\"datasetId\": \"80b70976-1d4d-4d3d-be3c-614301c4cbb3\"}, \"datasets\": 0}" # PLACEHOLDER
